...
function Cart() {
  return (
    <div>
    <div className="w-screen h-screen bg-white md:mt-20 flex">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 justify-between">
                        ...
                        <div className="flex flex-row gap-6 items-center">
                            <div className="w-full h-60">
                                <img className="w-full h-full" src="https://images.pexels.com/photos/699953/pexels-photo-699953.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Product" />
                            </div>
                            <div className="flex flex-col gap-1">
                                <p className="text-lg text-gray-800 font-semibold">Mexican salad</p>
                                <p className="text-xs text-gray-600 font-semibold">Color: <span className="font-normal">Black + Zinc</span></p>
                                <p className="text-xs text-gray-600 font-semibold">Rating: <span className="font-normal">5</span></p>
                            </div>
                        </div>
                        {/* Price Information */}
                        <div className="self-center text-center">
                            ...
                            <p className="text-gray-800 font-normal text-xl">$21</p>
                        </div>
                        {/* Remove Product Icon */}
                        <div className="self-center">
                            <button className="">
                                <svg className="" height="24px" width="24px" id="Layer_1" style={{ enableBackground: 'new 0 0 512 512' }} version="1.1" viewBox="0 0 512 512"  xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    <g>
