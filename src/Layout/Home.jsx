...
//             <p className="py-5 md:p-10">Welcome to <span className=' font-semibold text-orange-400'> JUSTEAT</span>, a pioneering food delivery app, has revolutionized the way we experience dining. With a vast network of partner restaurants offering a diverse array of cuisines, JustEat brings the world's flavors to your doorstep with just a few taps on your smartphone. Whether craving a hearty Italian pasta, a spicy Indian curry, or a comforting bowl of ramen, JustEat seamlessly connects hungry patrons with their favorite local eateries. With user-friendly interfaces, real-time tracking, and secure payment options, JustEat ensures a hassle-free and delightful dining experience for food lovers everywhere. Whether enjoying a cozy night in or hosting a gathering with friends, JustEat promises convenience, quality, and satisfaction with every order delivered straight to your door.</p>
//             <button className="btn md:ml-32 md:-mt-10 btn-warning">Explore Menu</button>
//         </div>
...
{/* <div className='w-full h-screen  grid grid-cols-1 sm:grid-cols-2 '>
                ...
                //                 <h1 className="text-5xl font-bold text-white">Satisfy Your Cravings, Delivered Fast!</h1>
                //                 <p className="py-6 text-gray-800">Experience culinary sophistication with convenience. Place your order today and savor the flavors of excellence delivered to your doorstep.</p>  
                //                 <button className='btn w-44   '><Link to="/user/register">Get Started</Link></button>
                //             </div>
                //         </div>
                //     </div>
                // </div>
            ...
            {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,224L48,202.7C96,181,192,139,288,138.7C384,139,480,181,576,176C672,171,768,117,864,96C960,75,1056,85,1152,85.3C1248,85,1344,75,1392,69.3L1440,64L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg> */}
